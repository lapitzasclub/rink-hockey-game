...
- Se corrigió la detección de gol para que no baste con quedar detrás de la línea dentro del alto de portería: ahora el gol solo cuenta si la bola entra desde la boca mirando al centro del campo, y se reforzaron los rebotes en postes/cantos de la portería.
- El usuario mostró después que el problema de portería era más profundo: en hockey patines la red/jaula no se atraviesa por detrás ni por laterales, y existe una base metálica inferior trasera que debe hacer rebotar la bola. Se rehízo la física para tratar la portería más como jaula simplificada con boca frontal válida y estructura lateral/trasera de rebote.
- Quedó detectado además un bug importante con portador: al pasar por detrás de la portería, el anclaje del balón al jugador podía recolocarlo artificialmente dentro del volumen de gol y provocar goles fantasma. Se blindó la posición anclada del balón cerca de portería para que no pueda colarse dentro de la boca/jaula de forma ilegal mientras el jugador rodea la estructura.
- Punto a retomar si aún hubiera rarezas: seguir afinando la geometría exacta de la jaula y la relación entre anclaje del balón al portador, rebote en estructura trasera y validación final de gol.
